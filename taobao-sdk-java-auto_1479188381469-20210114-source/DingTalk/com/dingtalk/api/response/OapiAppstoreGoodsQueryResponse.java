...
public class OapiAppstoreGoodsQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6693613568765946799L;
	...
	public static class OpenGoodsItemCycVo extends TaobaoObject {
		private static final long serialVersionUID = 7569845347242646383L;
		/**
		 * 周期别名
		 */
		@ApiField("alias_name")
	...
	public static class OpenGoodsItemVo extends TaobaoObject {
		private static final long serialVersionUID = 1511797476829891899L;
		/**
		 * 是否试用
		 */
	...
	public static class OpenGoodsVo extends TaobaoObject {
		private static final long serialVersionUID = 4559258981233434933L;
		/**
		 * 规格列表
		 */
