...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5555184529453598569L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 7635215765647455459L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 5592641387428969282L;
		/**
		 * orders
		 */
		@ApiListField("orders")
