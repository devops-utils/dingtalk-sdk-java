...
public class OapiReportTemplateGetbynameResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4546297829814665474L;
	...
	public static class DefaultReceivers extends TaobaoObject {
		private static final long serialVersionUID = 5668551528878325761L;
		/**
		 * 默认接收人名称
		 */
		@ApiField("user_name")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 8723673551876998421L;
		/**
		 * 模板字段名称
		 */
		@ApiField("field_name")
	...
	public static class BaseConversationVo extends TaobaoObject {
		private static final long serialVersionUID = 1732889413553614193L;
		/**
		 * 默认接收群id
		 */
	...
	public static class ReportTemplateResponseVo extends TaobaoObject {
		private static final long serialVersionUID = 5449959531767722296L;
		/**
		 * 默认接收群
		 */
