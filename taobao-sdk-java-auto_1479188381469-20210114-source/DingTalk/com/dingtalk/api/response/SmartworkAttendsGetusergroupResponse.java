...
public class SmartworkAttendsGetusergroupResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2871394635583961367L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 3833553822721587427L;
		/**
		 * 打卡时间跨几天
		 */
		@ApiField("across")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 2538868462528987921L;
		/**
		 * 班次中上下班详情列表
		 */
		@ApiListField("times")
	...
	public static class ClassSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 4574161723129784377L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassVo extends TaobaoObject {
		private static final long serialVersionUID = 4499134375282268664L;
		/**
		 * 班次id
		 */
		@ApiField("class_id")
	...
	public static class AtGroupFullForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7177361865293551139L;
		/**
		 * 考勤组中的班次列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 3747663182452254521L;
		/**
		 * dingOpenErrcode
		 */
