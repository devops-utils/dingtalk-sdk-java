...
public class OapiAtsPluginStatisticsResumeListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7168525775711446356L;
	...
	public static class TopResumeStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 5853256233553688758L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 4378842773262469657L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
