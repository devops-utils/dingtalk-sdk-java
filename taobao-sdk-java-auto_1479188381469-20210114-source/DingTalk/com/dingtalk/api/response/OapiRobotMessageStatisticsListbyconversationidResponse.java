...
public class OapiRobotMessageStatisticsListbyconversationidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4849416663925491486L;
	...
	public static class MsgStatByCIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 5119632316475925579L;
		/**
		 * 群Id
		 */
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 6288746611989154771L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 2792736289734552318L;
		/**
		 * list
		 */
		@ApiListField("list")
