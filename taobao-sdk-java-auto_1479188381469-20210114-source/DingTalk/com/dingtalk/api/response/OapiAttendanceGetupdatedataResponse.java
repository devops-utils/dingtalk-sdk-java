...
public class OapiAttendanceGetupdatedataResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3613285187555867794L;
	...
	public static class AtAttendanceResultForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 4283895213459493573L;
		/**
		 * 打卡类型 上班还是下班
		 */
		@ApiField("check_type")
	...
	public static class AtApproveForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7133362373955493575L;
		/**
		 * 审批单开始时间
		 */
		@ApiField("begin_time")
	...
	public static class AtAttendanceRecordForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 8264996995985658584L;
		/**
		 * 基本定位精度
		 */
	...
	public static class AtRestTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8624159697452283272L;
		/**
		 * 休息开始时间
		 */
	...
	public static class AtClassSettingInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 3669992463541825437L;
		/**
		 * restTimeVOList
		 */
	...
	public static class AtCheckInfoForOpenVo extends TaobaoObject {
		private static final long serialVersionUID = 7572616625123847132L;
		/**
		 * 审批单列表
		 */
