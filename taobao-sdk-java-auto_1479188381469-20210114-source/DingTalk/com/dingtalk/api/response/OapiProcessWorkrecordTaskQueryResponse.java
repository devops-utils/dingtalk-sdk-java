...
public class OapiProcessWorkrecordTaskQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5449548799864262918L;
	...
	public static class FormItemVo extends TaobaoObject {
		private static final long serialVersionUID = 2647714549848154973L;
		/**
		 * 内容
		 */
		@ApiField("content")
	...
	public static class WorkRecordVo extends TaobaoObject {
		private static final long serialVersionUID = 1771553269757761634L;
		/**
		 * 表单列表
		 */
		@ApiListField("forms")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 7543615816268867978L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
