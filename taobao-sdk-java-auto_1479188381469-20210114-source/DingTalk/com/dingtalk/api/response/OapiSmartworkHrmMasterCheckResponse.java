...
public class OapiSmartworkHrmMasterCheckResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4584286347573924567L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 4689391354555792211L;
		/**
		 * 业务UK唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 2359281519123851434L;
		/**
		 * 是否全部处理成功
		 */
