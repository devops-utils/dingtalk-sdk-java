...
public class OapiEduUseridGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4445843418863133724L;
	...
	public static class UserIdHold extends TaobaoObject {
		private static final long serialVersionUID = 1438877747169226666L;
		/**
		 * 手机号码
		 */
		@ApiField("mobile")
	...
	public static class OpenEduUserIdListResponse extends TaobaoObject {
		private static final long serialVersionUID = 2512466962785935775L;
		/**
		 * 用户id列表
		 */
		@ApiListField("users")
