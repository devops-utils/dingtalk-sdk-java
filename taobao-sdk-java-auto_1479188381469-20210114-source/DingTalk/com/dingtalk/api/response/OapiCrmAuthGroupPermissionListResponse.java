...
public class OapiCrmAuthGroupPermissionListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2415458357337698811L;
	...
	public static class OperateScope extends TaobaoObject {
		private static final long serialVersionUID = 2467248939159622644L;
		/**
		 * 是否有权限
		 */
		@ApiField("has_auth")
	...
	public static class DeptInfo extends TaobaoObject {
		private static final long serialVersionUID = 3537867677227612426L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class StaffInfo extends TaobaoObject {
		private static final long serialVersionUID = 2182252865634631374L;
		/**
		 * 员工名称
		 */
		@ApiField("name")
	...
	public static class Ext extends TaobaoObject {
		private static final long serialVersionUID = 7847539155172349739L;
		/**
		 * 管理部门信息
		 */
	...
	public static class ManageScope extends TaobaoObject {
		private static final long serialVersionUID = 1881748541934917651L;
		/**
		 * 扩展内容
		 */
		@ApiField("ext")
	...
	public static class AuthObjects extends TaobaoObject {
		private static final long serialVersionUID = 3584565446959924618L;
		/**
		 * 表单名称
		 */
		@ApiField("label")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 8582426686797188465L;
		/**
		 * 权限内容
		 */
