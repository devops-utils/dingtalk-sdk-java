...
public class OapiAttendanceClassGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8444653317294482473L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 4558335545312491513L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class AtClassSettingForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2865428737813916318L;
		/**
		 * classId
		 */
		@ApiField("class_id")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 2311734389591469697L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7683747259998728964L;
		/**
		 * 考勤组班次配置
		 */
