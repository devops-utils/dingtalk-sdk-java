...
public class OapiProcessFormGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5143289248783476825L;
	...
	public static class FormComponentStatVo extends TaobaoObject {
		private static final long serialVersionUID = 2313465917644759343L;
		/**
		 * 组件id
		 */
		@ApiField("id")
	...
	public static class LinkageTargetVo extends TaobaoObject {
		private static final long serialVersionUID = 2836496987481457397L;
		/**
		 * 对应目标的行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 6826282783524546819L;
		/**
		 * 联动对应的目标
		 */
	...
	public static class FormComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 7788695828845329991L;
		/**
		 * 考勤类型文案
		 */
	...
	public static class FormComponent2Vo extends TaobaoObject {
		private static final long serialVersionUID = 1274215721525168768L;
		/**
		 * 控件类型
		 */
	...
	public static class FormComponent1Vo extends TaobaoObject {
		private static final long serialVersionUID = 6457849114788568894L;
		/**
		 * 子组件
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 4171667565653421931L;
		/**
		 * 子组件
		 */
		@ApiListField("children")
	...
	public static class ProcessTopVo extends TaobaoObject {
		private static final long serialVersionUID = 2346187413339857148L;
		/**
		 * 表单列表
		 */
