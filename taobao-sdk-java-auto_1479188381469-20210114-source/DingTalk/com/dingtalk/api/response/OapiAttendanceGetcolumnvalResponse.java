...
public class OapiAttendanceGetcolumnvalResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5844836855949936237L;
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 4674167632961776386L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6396698683933158456L;
		/**
		 * 列id
		 */
		@ApiField("id")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6541425729538226422L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1139964211343643253L;
		/**
		 * 列信息与列值数据
		 */
		@ApiListField("column_vals")
