...
public class OapiKacDatavVideoliveDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4422745324863629114L;
	...
	public static class VideoLiveDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 2141532581224249335L;
		/**
		 * 直播群cid
		 */
		@ApiField("cid")
	...
	public static class VideoLiveDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 2646162278656456418L;
		/**
		 * 数据明细列表
		 */
		@ApiListField("data")
