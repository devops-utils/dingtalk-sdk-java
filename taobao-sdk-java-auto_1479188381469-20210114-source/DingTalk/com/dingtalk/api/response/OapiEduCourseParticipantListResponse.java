...
public class OapiEduCourseParticipantListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4653994111216576473L;
	...
	public static class CourseParticipantVO extends TaobaoObject {
		private static final long serialVersionUID = 1276679651339784348L;
		/**
		 * 参与方的组织CorpId
		 */
	...
	public static class ListCourseParticipantResponse extends TaobaoObject {
		private static final long serialVersionUID = 4664919429814949961L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
