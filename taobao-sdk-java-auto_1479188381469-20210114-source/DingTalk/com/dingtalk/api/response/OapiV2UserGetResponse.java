...
public class OapiV2UserGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2531837636972263361L;
	...
	public static class DeptOrder extends TaobaoObject {
		private static final long serialVersionUID = 4259553961788269475L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class DeptLeader extends TaobaoObject {
		private static final long serialVersionUID = 1629899581199848298L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class UserRole extends TaobaoObject {
		private static final long serialVersionUID = 1874432362231475995L;
		/**
		 * 角色组名称
		 */
		@ApiField("group_name")
	...
	public static class UnionEmpMapVo extends TaobaoObject {
		private static final long serialVersionUID = 4486165888127785416L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UnionEmpExt extends TaobaoObject {
		private static final long serialVersionUID = 6649186529842971618L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
	...
	public static class UserGetResponse extends TaobaoObject {
		private static final long serialVersionUID = 1219266346955929142L;
		/**
		 * 是否激活
		 */
		@ApiField("active")
