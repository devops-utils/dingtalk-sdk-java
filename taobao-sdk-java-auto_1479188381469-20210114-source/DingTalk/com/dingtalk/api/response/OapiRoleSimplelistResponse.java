...
public class OapiRoleSimplelistResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4755552858727779372L;
	...
	public static class OrgDeptVo extends TaobaoObject {
		private static final long serialVersionUID = 6429646773682792397L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class OpenEmpSimple extends TaobaoObject {
		private static final long serialVersionUID = 3792384835338457168L;
		/**
		 * 管理范围
		 */
	...
	public static class PageVo extends TaobaoObject {
		private static final long serialVersionUID = 2391797854282253262L;
		/**
		 * 后面是否还有数据
		 */
		@ApiField("hasMore")
