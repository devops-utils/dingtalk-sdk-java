...
/**
 * TOP DingTalk-API: dingtalk.oapi.ats.plugin.statistics.job.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiAtsPluginStatisticsJobListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 3638281154818297415L;
	...
	public static class TopJobStatisticsVo extends TaobaoObject {
		private static final long serialVersionUID = 4671666799517564553L;
		/**
		 * 招聘业务标识
		 */
		@ApiField("biz_code")
	...
	public static class AtsPageResult extends TaobaoObject {
		private static final long serialVersionUID = 3511733573173763924L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
