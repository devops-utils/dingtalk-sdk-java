...
public class OapiEduCourseSummadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5729217574928738371L;
	...
	public static class CourseSummaryDataDTO extends TaobaoObject {
		private static final long serialVersionUID = 8736228931932172484L;
		/**
		 * 数据类别业务唯一键
		 */
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 2563151142689446249L;
		/**
		 * 表示是否还有更多的数据
		 */
		@ApiField("has_more")
