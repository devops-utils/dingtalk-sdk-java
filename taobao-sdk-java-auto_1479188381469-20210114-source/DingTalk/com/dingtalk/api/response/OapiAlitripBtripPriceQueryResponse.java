...
public class OapiAlitripBtripPriceQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4678589824478343151L;
	...
	public static class HotelFeeDetail extends TaobaoObject {
		private static final long serialVersionUID = 7132657783438719539L;
		/**
		 * 城市
		 */
		@ApiField("city")
	...
	public static class MostExpensive extends TaobaoObject {
		private static final long serialVersionUID = 5752457828546974268L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class Cheapest extends TaobaoObject {
		private static final long serialVersionUID = 6128852537689986242L;
		/**
		 * 到达时间
		 */
		@ApiField("arr_time")
	...
	public static class BtripRoutes extends TaobaoObject {
		private static final long serialVersionUID = 6281531549148757464L;
		/**
		 * 最低价
		 */
		@ApiField("cheapest")
	...
	public static class TrafficFee extends TaobaoObject {
		private static final long serialVersionUID = 7724254141479335367L;
		/**
		 * 行程费用
		 */
	...
	public static class Module extends TaobaoObject {
		private static final long serialVersionUID = 7822885161716851882L;
		/**
		 * 酒店差标
		 */
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 6599365314281839813L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
