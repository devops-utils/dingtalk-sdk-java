...
public class OapiPbpInstanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6384554795913147628L;
	...
	public static class PositionVo extends TaobaoObject {
		private static final long serialVersionUID = 7317532748321667473L;
		/**
		 * 成员id，根据类型不同表示不同
		 */
		@ApiField("member_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 2347641459146337532L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
