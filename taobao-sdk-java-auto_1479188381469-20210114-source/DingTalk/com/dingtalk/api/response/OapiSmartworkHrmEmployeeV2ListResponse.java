...
public class OapiSmartworkHrmEmployeeV2ListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7416837296425791922L;
	...
	public static class FieldValueVo extends TaobaoObject {
		private static final long serialVersionUID = 3882255864347829671L;
		/**
		 * 标识第几条明细（下标从0开始）
		 */
		@ApiField("item_index")
	...
	public static class EmpFieldDataVo extends TaobaoObject {
		private static final long serialVersionUID = 6448889938585187145L;
		/**
		 * 字段标识
		 */
		@ApiField("field_code")
	...
	public static class EmpRosterFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 6452118127785666714L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
