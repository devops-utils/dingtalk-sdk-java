...
public class OapiAttendanceShiftHistoryQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5612387249138665992L;
	...
	public static class TopShiftSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 6157117189294864987L;
		/**
		 * 该班次对应的出勤天数
		 */
	...
	public static class TopPunchVo extends TaobaoObject {
		private static final long serialVersionUID = 8878673884695163454L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopRestVo extends TaobaoObject {
		private static final long serialVersionUID = 7296532479581693615L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class TopSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 1883192137661393346L;
		/**
		 * id
		 */
		@ApiField("id")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 3582236564656836943L;
		/**
		 * 企业id
		 */
		@ApiField("corp_id")
