...
public class OapiWikiDocListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7124395667294634774L;
	...
	public static class OpenDocVO extends TaobaoObject {
		private static final long serialVersionUID = 5432233148274447568L;
		/**
		 * 知识库ID（加密后的）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 7226367756249161357L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
