...
public class OapiWikiDocPublicListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4198951575961698391L;
	...
	public static class OpenDocVo extends TaobaoObject {
		private static final long serialVersionUID = 7659477584654114418L;
		/**
		 * 知识页所在知识库id（加密后的值）
		 */
		@ApiField("group_id")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 5572982413458917659L;
		/**
		 * 知识页列表
		 */
		@ApiListField("data")
