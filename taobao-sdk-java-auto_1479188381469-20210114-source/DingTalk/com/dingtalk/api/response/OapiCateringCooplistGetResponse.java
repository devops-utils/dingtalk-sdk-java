...
public class OapiCateringCooplistGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3824355181411338647L;
	...
	public static class Mealitemlist extends TaobaoObject {
		private static final long serialVersionUID = 1634464829467266591L;
		/**
		 * 送达时间 HH:mm
		 */
	...
	public static class MealSettingList extends TaobaoObject {
		private static final long serialVersionUID = 4249587258183968295L;
		/**
		 * 缩略地址，可为空
		 */
		@ApiField("address")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 6515345582297541327L;
		/**
		 * 是否有下一项数据
		 */
		@ApiField("has_next")
