...
public class OapiCrmObjectdataContactQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4624949661746736775L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 2137861717825518985L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 4328791157122345994L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 7443465536466724367L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
