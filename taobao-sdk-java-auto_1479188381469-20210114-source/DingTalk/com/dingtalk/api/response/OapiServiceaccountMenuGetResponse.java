...
public class OapiServiceaccountMenuGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6873355318654454366L;
	...
	public static class MenuSubButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 2382864172676399641L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuButtonDTO extends TaobaoObject {
		private static final long serialVersionUID = 5511822286575345651L;
		/**
		 * 菜单绑定的key值
		 */
		@ApiField("key")
	...
	public static class MenuConfigDTO extends TaobaoObject {
		private static final long serialVersionUID = 2464645811432724978L;
		/**
		 * 菜单按钮列表
		 */
		@ApiListField("button")
