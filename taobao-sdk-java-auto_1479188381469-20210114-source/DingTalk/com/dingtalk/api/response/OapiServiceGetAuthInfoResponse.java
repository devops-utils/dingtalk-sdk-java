...
public class OapiServiceGetAuthInfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8536471289942987542L;
	...
	public static class Agent extends TaobaoObject {
		private static final long serialVersionUID = 4272475183754465715L;
		/**
		 * admin_list
		 */
	...
	public static class AuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 2436419287917774694L;
		/**
		 * agent
		 */
		@ApiListField("agent")
	...
	public static class AuthUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 7819819617392143533L;
		/**
		 * userId
		 */
		@ApiField("userId")
	...
	public static class AuthCorpInfo extends TaobaoObject {
		private static final long serialVersionUID = 3368197874288238862L;
		/**
		 * auth_channel
		 */
	...
	public static class Channelagent extends TaobaoObject {
		private static final long serialVersionUID = 5736636346356168561L;
		/**
		 * agent_name
		 */
		@ApiField("agent_name")
	...
	public static class ChannelAuthInfo extends TaobaoObject {
		private static final long serialVersionUID = 3791582938961466439L;
		/**
		 * channelAgent
		 */
