...
public class OapiEduSubjectMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2517494797471523161L;
	...
	public static class SubjectMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 5286815392148448724L;
		/**
		 * 区域编码
		 */
		@ApiField("area_code")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 4532435341731591675L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
