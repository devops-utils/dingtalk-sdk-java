...
public class OapiRobotMessageStatisticsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7874713262779129358L;
	...
	public static class MsgStatResVo extends TaobaoObject {
		private static final long serialVersionUID = 1292637477657742915L;
		/**
		 * 机器人消息推送Id
		 */
		@ApiField("push_id")
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 3535852645831598756L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 3687469636257639439L;
		/**
		 * list
		 */
		@ApiListField("list")
