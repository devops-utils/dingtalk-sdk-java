...
public class OapiAttendanceVacationQuotaListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6526486282256736926L;
	...
	public static class Leavequotas extends TaobaoObject {
		private static final long serialVersionUID = 3642915759834596324L;
		/**
		 * 额度有效期结束时间(毫秒级时间戳)
		 */
		@ApiField("end_time")
	...
	public static class OapiLeaveQuotaUserListVo extends TaobaoObject {
		private static final long serialVersionUID = 3716956678562125879L;
		/**
		 * 是否存在更多记录
		 */
		@ApiField("has_more")
