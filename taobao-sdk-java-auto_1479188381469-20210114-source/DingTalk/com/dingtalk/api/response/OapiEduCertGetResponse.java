...
public class OapiEduCertGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3685558534963727838L;
	...
	public static class Certdata extends TaobaoObject {
		private static final long serialVersionUID = 3158336244865439843L;
		/**
	...
	public static class OpenPracticalTaskData extends TaobaoObject {
		private static final long serialVersionUID = 8494845199653767617L;
		/**
		 * true表示完成，false表示未完成
		 */
		@ApiField("finish")
	...
	public static class OpenQueryCertResponse extends TaobaoObject {
		private static final long serialVersionUID = 4381638672696191376L;
		/**
		 * 认证明细
		 */
