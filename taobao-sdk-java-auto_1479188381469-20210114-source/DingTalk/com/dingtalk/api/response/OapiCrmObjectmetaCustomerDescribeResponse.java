...
public class OapiCrmObjectmetaCustomerDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4386961451243773393L;
	...
	public static class SelectOptions extends TaobaoObject {
		private static final long serialVersionUID = 5652562573173136416L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class ReferenceFields extends TaobaoObject {
		private static final long serialVersionUID = 1354314918964979453L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class RollUpSummaryFields extends TaobaoObject {
		private static final long serialVersionUID = 1768367666529494435L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 6461212124486142437L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 5586878737151378849L;
		/**
		 * 是否自定义对象
		 */
		@ApiField("customized")
