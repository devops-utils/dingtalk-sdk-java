...
public class OapiEduTextbookMetadataListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1553324769319577613L;
	...
	public static class TextbookMetadataDTO extends TaobaoObject {
		private static final long serialVersionUID = 6824772226657257126L;
		/**
		 * 教材id
		 */
		@ApiField("id")
	...
	public static class PageQueryResponse extends TaobaoObject {
		private static final long serialVersionUID = 5354119871741583234L;
		/**
		 * 是否还有更多数据
		 */
		@ApiField("has_more")
