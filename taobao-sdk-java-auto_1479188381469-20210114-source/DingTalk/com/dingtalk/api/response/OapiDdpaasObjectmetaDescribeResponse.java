...
public class OapiDdpaasObjectmetaDescribeResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6784854595245234491L;
	...
	public static class Selectoptions extends TaobaoObject {
		private static final long serialVersionUID = 3361724935233384616L;
		/**
		 * 选项key
		 */
		@ApiField("key")
	...
	public static class Referencefields extends TaobaoObject {
		private static final long serialVersionUID = 1148222469374554788L;
		/**
		 * 引用的关联对象字段格式
		 */
		@ApiField("format")
	...
	public static class Rollupsummaryfields extends TaobaoObject {
		private static final long serialVersionUID = 3256493436378317499L;
		/**
		 * 汇总方法
		 */
		@ApiField("aggregator")
	...
	public static class Fields extends TaobaoObject {
		private static final long serialVersionUID = 6897223127638338398L;
		/**
		 * 是否自定义字段
		 */
		@ApiField("customized")
	...
	public static class DObject extends TaobaoObject {
		private static final long serialVersionUID = 2721716173166614977L;
		/**
		 * 字段列表
		 */
		@ApiListField("fields")
