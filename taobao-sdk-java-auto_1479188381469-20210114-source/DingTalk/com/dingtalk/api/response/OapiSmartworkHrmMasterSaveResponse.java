...
public class OapiSmartworkHrmMasterSaveResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2548789876757773485L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 2838297116181457757L;
		/**
		 * 业务流水唯一标识，和入参一致
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVO extends TaobaoObject {
		private static final long serialVersionUID = 8853723785326568989L;
		/**
		 * 是否全部保存成功
		 */
