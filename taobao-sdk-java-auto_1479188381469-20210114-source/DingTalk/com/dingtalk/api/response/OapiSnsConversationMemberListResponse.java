...
public class OapiSnsConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2261898391116926291L;
	...
	public static class SnsGroupMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 5599734852619348139L;
		/**
		 * 群昵称
		 */
	...
	public static class SnsOpenGroupMemberResponse extends TaobaoObject {
		private static final long serialVersionUID = 1276575488786122345L;
		/**
		 * 群成员是否还有下页数据
		 */
		@ApiField("has_more")
