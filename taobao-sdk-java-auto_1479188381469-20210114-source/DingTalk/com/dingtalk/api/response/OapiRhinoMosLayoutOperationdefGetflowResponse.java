...
public class OapiRhinoMosLayoutOperationdefGetflowResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1822395712663494439L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 3359339269877726684L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 7245848854358193239L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8232292865877599571L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 7435644692456972655L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 3819164574174596776L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 3344885691888558631L;
		/**
		 * 适用尺码
		 */
	...
	public static class OperationDefFlowDto extends TaobaoObject {
		private static final long serialVersionUID = 3276596933573769879L;
		/**
		 * 是否激活最大版本
		 */
		@ApiField("active")
