...
public class OapiDingmiGroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1617862296187212672L;
	...
	public static class GroupMemberChatData extends TaobaoObject {
		private static final long serialVersionUID = 3697718271974277797L;
		/**
		 * 聊天记录数
		 */
		@ApiField("chat_cnt")
	...
	public static class GroupChatDataResult extends TaobaoObject {
		private static final long serialVersionUID = 4363467196397829453L;
		/**
		 * 是否来自缓存
		 */
		@ApiField("from_cache")
