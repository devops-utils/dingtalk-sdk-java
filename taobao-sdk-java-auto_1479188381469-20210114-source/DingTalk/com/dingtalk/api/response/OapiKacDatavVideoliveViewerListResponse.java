...
public class OapiKacDatavVideoliveViewerListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5528929258141799516L;
	...
	public static class GroupLiveViewer extends TaobaoObject {
		private static final long serialVersionUID = 2166971166543341222L;
		/**
		 * 观看直播时长（毫秒）
		 */
	...
	public static class GroupLiveViewerPageResult extends TaobaoObject {
		private static final long serialVersionUID = 2864771141839934237L;
		/**
		 * 列表数据项
		 */
		@ApiListField("data")
