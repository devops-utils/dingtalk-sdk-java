...
public class OapiAttendanceGetleavetimebynamesResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3137158533165371491L;
	...
	public static class ColumnForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1856764677915121557L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ColumnDayAndVal extends TaobaoObject {
		private static final long serialVersionUID = 7167174961283926565L;
		/**
		 * 时间
		 */
		@ApiField("date")
	...
	public static class ColumnValForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1498268528659277522L;
		/**
		 * 列值数据
		 */
	...
	public static class ColumnValListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 1537364358528492767L;
		/**
		 * 列信息与列值数据
		 */
