...
public class OapiCspaceAuditlogListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7743952892524245262L;
	...
	public static class AuditLogVO extends TaobaoObject {
		private static final long serialVersionUID = 8515849837991737561L;
		/**
		 * 操作类型
		 */
		@ApiField("action")
	...
	public static class ListAuditLogResult extends TaobaoObject {
		private static final long serialVersionUID = 2131414993293851968L;
		/**
		 * 记录列表
		 */
		@ApiListField("list")
