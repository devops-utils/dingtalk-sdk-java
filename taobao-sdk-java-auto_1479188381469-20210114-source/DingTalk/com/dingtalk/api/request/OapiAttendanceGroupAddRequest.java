...
public class OapiAttendanceGroupAddRequest extends BaseTaobaoRequest<OapiAttendanceGroupAddResponse> {
	...
	* 考勤组信息
	...
	public static class TopPositionVo extends TaobaoObject {
		private static final long serialVersionUID = 3335542918228274221L;
		/**
		 * 精度
		 */
		@ApiField("accuracy")
	...
	public static class TopShiftVo extends TaobaoObject {
		private static final long serialVersionUID = 3647921834397699164L;
		/**
		 * 班次id
		 */
		@ApiField("id")
	...
	public static class TopMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 4244463225757354395L;
		/**
		 * corpId
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupManageRolePermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 5555914917532627995L;
		/**
		 * 设置拍照打卡规则
		 */
	...
	public static class TopWifiVo extends TaobaoObject {
		private static final long serialVersionUID = 7268724667515822331L;
		/**
		 * 企业corpid
		 */
		@ApiField("corp_id")
	...
	public static class TopGroupVo extends TaobaoObject {
		private static final long serialVersionUID = 5429548852848116886L;
		/**
		 * 打卡是否需要健康码
		 */
