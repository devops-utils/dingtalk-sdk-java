...
public class OapiMessageSendToConversationRequest extends BaseTaobaoRequest<OapiMessageSendToConversationResponse> {
	...
	* voice消息
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 4231218662873294932L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 7893267587842268235L;
		/**
		 * 消息体的关键字对应的值
		 */
		@ApiField("key")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 6442829567251296217L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 3325785265147298991L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 3645429233794155184L;
		/**
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 4496414796878819961L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 2647756565244479622L;
		/**
		 * 语音时长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 5754273948979956577L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 6851383758692198456L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 1513769794429128436L;
		/**
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 8123174477151281753L;
		/**
		 * 消息内容
		 */
		@ApiField("content")
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 5368173394661733855L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 5687212512848833841L;
		/**
		 * 使用独立跳转ActionCard样式时的按钮列表；必须与btn_orientation同时设置
		 */
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 6727986765851542187L;
		/**
		 * 消息内容，支持markdown，语法参考标准markdown语法。图片举例：![alt text](mediaId)
		 */
