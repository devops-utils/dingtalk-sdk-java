...
public class OapiRobotSendRequest extends BaseTaobaoRequest<OapiRobotSendResponse> {
	...
	* text类型
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 5123552545368556568L;
		/**
		 * text类型
		 */
		@ApiField("content")
	...
	public static class At extends TaobaoObject {
		private static final long serialVersionUID = 8738122447173566266L;
		/**
		 * 被@人的手机号
		 */
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 7729547446864815988L;
		/**
		 * 点击消息跳转的URL
		 */
		@ApiField("messageUrl")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 1498311419543481461L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class Btns extends TaobaoObject {
		private static final long serialVersionUID = 6867284745467812585L;
		/**
		 * 按钮方案，
		 */
		@ApiField("actionURL")
	...
	public static class Actioncard extends TaobaoObject {
		private static final long serialVersionUID = 2786647569889161925L;
		/**
		 * 0-按钮竖直排列，1-按钮横向排列
		 */
	...
	public static class Links extends TaobaoObject {
		private static final long serialVersionUID = 8644299877398498988L;
		/**
		 * 点击单条信息到跳转链接
		 */
		@ApiField("messageURL")
	...
	public static class Feedcard extends TaobaoObject {
		private static final long serialVersionUID = 8513213676715941173L;
		/**
		 * links
		 */
		@ApiListField("links")
