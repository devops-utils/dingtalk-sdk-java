...
public class OapiChatSendRequest extends BaseTaobaoRequest<OapiChatSendResponse> {
	...
	* 语音消息
	...
	public static class BtnJson extends TaobaoObject {
		private static final long serialVersionUID = 5358721243735923211L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 4574777823315676934L;
		/**
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 1638193484628262676L;
		/**
		 * 消息头部背景颜色
		 */
		@ApiField("bgcolor")
	...
	public static class Rich extends TaobaoObject {
		private static final long serialVersionUID = 4195852424958648389L;
		/**
		 * 单行富文本信息的单位
		 */
		@ApiField("num")
	...
	public static class Form extends TaobaoObject {
		private static final long serialVersionUID = 7391213416625759664L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 6848458775782886784L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class Oa extends TaobaoObject {
		private static final long serialVersionUID = 8824373978941355352L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 8813426844639181624L;
		/**
		 * 语音正整数，小于60，表示音频时长长
		 */
		@ApiField("duration")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 2169975347948148829L;
		/**
		 * 文件mediaId
		 */
		@ApiField("media_id")
	...
	public static class Image extends TaobaoObject {
		private static final long serialVersionUID = 4255297157297229596L;
		/**
		 * 图片mediaId
		 */
		@ApiField("media_id")
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 3728973511766416412L;
		/**
		 * 消息点击链接地址
		 */
		@ApiField("messageUrl")
	...
	public static class Text extends TaobaoObject {
		private static final long serialVersionUID = 7582689817792923977L;
		/**
		 * 文本消息内容
		 */
		@ApiField("content")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 3384889249316549538L;
		/**
		 * markdown格式的消息
		 */
		@ApiField("text")
	...
	public static class BtnJsonList extends TaobaoObject {
		private static final long serialVersionUID = 8277822373994428321L;
		/**
	...
	public static class Msg extends TaobaoObject {
		private static final long serialVersionUID = 3334835718425766698L;
		/**
		 * action_card卡片消息
		 */
