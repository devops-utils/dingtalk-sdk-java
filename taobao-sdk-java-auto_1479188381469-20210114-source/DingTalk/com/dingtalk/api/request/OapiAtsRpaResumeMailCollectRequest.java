...
public class OapiAtsRpaResumeMailCollectRequest extends BaseTaobaoRequest<OapiAtsRpaResumeMailCollectResponse> {
	...
	* 简历文件参数
	...
	public static class MailContent extends TaobaoObject {
		private static final long serialVersionUID = 6553833145612451656L;
		/**
		 * 邮件正文，可选
		 */
		@ApiField("body_html")
	...
	public static class ResumeFileStoreVo extends TaobaoObject {
		private static final long serialVersionUID = 3399226147461533736L;
		/**
		 * 下载地址
		 */
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 3367327474575385775L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 6341663792694567186L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 8611967328125917256L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 5617968384163495374L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 4887212146997763274L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 1364841764531762184L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
