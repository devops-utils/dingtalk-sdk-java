...
public class OapiAtsJobBatchaddRequest extends BaseTaobaoRequest<OapiAtsJobBatchaddResponse> {
	...
	* 操作人员工标识
	...
	public static class JobExtDataVo extends TaobaoObject {
		private static final long serialVersionUID = 5799888829679714566L;
		/**
		 * 招募人数
		 */
		@ApiField("head_count")
	...
	public static class JobAddressVo extends TaobaoObject {
		private static final long serialVersionUID = 6843689811452986468L;
		/**
		 * 位置详情
		 */
		@ApiField("detail")
	...
	public static class AtsAddJobParam extends TaobaoObject {
		private static final long serialVersionUID = 5242228785543596447L;
		/**
		 * 工作地点
		 */
		@ApiField("address")
