...
public class OapiAtsResumeAddRequest extends BaseTaobaoRequest<OapiAtsResumeAddResponse> {
	...
	* 简历文件参数
	...
	public static class EducationInfo extends TaobaoObject {
		private static final long serialVersionUID = 2837977377635754516L;
		/**
		 * 学历
		 */
		@ApiField("education")
	...
	public static class ExperienceInfo extends TaobaoObject {
		private static final long serialVersionUID = 1162677543325869594L;
		/**
		 * 公司名称
		 */
		@ApiField("company")
	...
	public static class TrainingInfo extends TaobaoObject {
		private static final long serialVersionUID = 8431658169943274114L;
		/**
		 * 所获证书
		 */
	...
	public static class ProjectInfo extends TaobaoObject {
		private static final long serialVersionUID = 5491811687911666618L;
		/**
		 * 结束时间
		 */
		@ApiField("end_date")
	...
	public static class ResumeDetailInfo extends TaobaoObject {
		private static final long serialVersionUID = 4483559496831485595L;
		/**
		 * 学位
		 */
	...
	public static class CollResumeMailParam extends TaobaoObject {
		private static final long serialVersionUID = 3345332934463968223L;
		/**
		 * 渠道来源，接入前请提前沟通
		 */
		@ApiField("channel")
