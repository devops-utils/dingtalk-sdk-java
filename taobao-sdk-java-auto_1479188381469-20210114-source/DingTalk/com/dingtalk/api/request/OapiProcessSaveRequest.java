...
public class OapiProcessSaveRequest extends BaseTaobaoRequest<OapiProcessSaveResponse> {
	...
	* 入参
	...
	public static class FormComponentStatVo extends TaobaoObject {
		private static final long serialVersionUID = 7111672239883127574L;
		/**
		 * 组件id
		 */
		@ApiField("id")
	...
	public static class FormComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 5637643663273972829L;
		/**
		 * 增加明细动作名称
		 */
	...
	public static class FormComponentVo2 extends TaobaoObject {
		private static final long serialVersionUID = 5413544795642381261L;
		/**
		 * 表单名称
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 7516993915559154786L;
		/**
		 * 子表单列表
		 */
	...
	public static class ProcessConfig extends TaobaoObject {
		private static final long serialVersionUID = 3869513186212439264L;
		/**
		 * 是否在审批后台禁用删除操作
		 */
	...
	public static class SaveProcessRequest extends TaobaoObject {
		private static final long serialVersionUID = 1825661396626912137L;
		/**
		 * 企业应用id
		 */
		@ApiField("agentid")
