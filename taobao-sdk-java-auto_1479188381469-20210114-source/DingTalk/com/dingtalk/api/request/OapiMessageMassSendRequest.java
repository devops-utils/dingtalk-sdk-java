...
public class OapiMessageMassSendRequest extends BaseTaobaoRequest<OapiMessageMassSendResponse> {
	...
	* 调用时填写随机生成的UUID, 防止消息重复发送
	...
	public static class Voice extends TaobaoObject {
		private static final long serialVersionUID = 6728763632877782579L;
		/**
		 * 正整数，小于60，表示音频时长
		 */
		@ApiField("duration")
	...
	public static class Head extends TaobaoObject {
		private static final long serialVersionUID = 1113241242485711938L;
		/**
	...
	public static class FormItem extends TaobaoObject {
		private static final long serialVersionUID = 3754928572535267471L;
		/**
		 * 消息体的关键字
		 */
		@ApiField("key")
	...
	public static class RichText extends TaobaoObject {
		private static final long serialVersionUID = 2422244962626849193L;
		/**
		 * 单行富文本信息的数目
		 */
		@ApiField("num")
	...
	public static class Body extends TaobaoObject {
		private static final long serialVersionUID = 4195235958734383341L;
		/**
		 * 自定义的作者名字
		 */
		@ApiField("author")
	...
	public static class OA extends TaobaoObject {
		private static final long serialVersionUID = 3212964742578118712L;
		/**
		 * 消息体
		 */
		@ApiField("body")
	...
	public static class File extends TaobaoObject {
		private static final long serialVersionUID = 2457161391982167286L;
		/**
	...
	public static class Link extends TaobaoObject {
		private static final long serialVersionUID = 3884316726353545739L;
		/**
		 * 消息点击链接地址，当发送消息为小程序时支持小程序跳转链接
		 */
		@ApiField("message_url")
	...
	public static class Markdown extends TaobaoObject {
		private static final long serialVersionUID = 6141359426361925562L;
		/**
	...
	public static class Button extends TaobaoObject {
		private static final long serialVersionUID = 6846129789299191922L;
		/**
	...
	public static class ActionCard extends TaobaoObject {
		private static final long serialVersionUID = 1645175135244873816L;
		/**
	...
	public static class MessageBody extends TaobaoObject {
		private static final long serialVersionUID = 8844899893569259265L;
		/**
		 * action_card卡片消息
		 */
