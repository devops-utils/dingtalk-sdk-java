...
public class OapiCollectionSchemaCreateRequest extends BaseTaobaoRequest<OapiCollectionSchemaCreateResponse> {
	...
	* 根请求
	...
	public static class ProcessVisibleValueVo extends TaobaoObject {
		private static final long serialVersionUID = 2142463493141316199L;
		/**
		 * 类型
		 */
	...
	public static class FormSchemaSettingVo extends TaobaoObject {
		private static final long serialVersionUID = 5893286963911388519L;
		/**
		 * 业务类型
		 */
		@ApiField("biz_type")
	...
	public static class BehaviorTarget extends TaobaoObject {
		private static final long serialVersionUID = 6212985776492943513L;
		/**
		 * 行为
		 */
		@ApiField("behavior")
	...
	public static class BehaviorLinkageVo extends TaobaoObject {
		private static final long serialVersionUID = 1678688623894176997L;
		/**
		 * 选项级联目标
		 */
	...
	public static class ComponentPropOptionVo extends TaobaoObject {
		private static final long serialVersionUID = 8429713469419865515L;
		/**
		 * 名称
		 */
		@ApiField("key")
	...
	public static class ComponentMatrixDefVo extends TaobaoObject {
		private static final long serialVersionUID = 6127675137162777632L;
		/**
		 * 别名
		 */
		@ApiField("alias")
	...
	public static class ComponentPropVo extends TaobaoObject {
		private static final long serialVersionUID = 4715982549557198831L;
		/**
		 * 选项级联属性
		 */
	...
	public static class FormComponentVo extends TaobaoObject {
		private static final long serialVersionUID = 5879226582622144637L;
		/**
		 * 控件名称
		 */
	...
	public static class FormContentVo extends TaobaoObject {
		private static final long serialVersionUID = 3526659941268159352L;
		/**
		 * 控件数组
		 */
		@ApiListField("items")
	...
	public static class SaveFormSchemaRequest extends TaobaoObject {
		private static final long serialVersionUID = 4216471173673833459L;
		/**
		 * 控件字符串
		 */
		@ApiField("content")
