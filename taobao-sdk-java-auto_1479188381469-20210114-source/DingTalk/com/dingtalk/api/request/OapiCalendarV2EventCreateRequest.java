...
public class OapiCalendarV2EventCreateRequest extends BaseTaobaoRequest<OapiCalendarV2EventCreateResponse> {
	...
	* 日程创建对象
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 8176191164743816711L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 1549848129781671888L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 1577946724424196956L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 6332256232416911632L;
		/**
		 * 纬度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 5767312721435922266L;
		/**
		 * 日程参与者，参与者最大人数为100(包括组织者)
		 */
