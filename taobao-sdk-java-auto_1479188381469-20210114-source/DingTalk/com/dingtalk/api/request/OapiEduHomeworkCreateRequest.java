...
public class OapiEduHomeworkCreateRequest extends BaseTaobaoRequest<OapiEduHomeworkCreateResponse> {
	...
	* 老师userid
	...
	public static class ClassInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 6221215637486189456L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
	...
	public static class StuInfoItem extends TaobaoObject {
		private static final long serialVersionUID = 5834787825652173945L;
		/**
		 * 学生userid
		 */
		@ApiField("stu_id")
	...
	public static class SelectStuItem extends TaobaoObject {
		private static final long serialVersionUID = 8143197116881752124L;
		/**
		 * 班级ID
		 */
		@ApiField("class_id")
