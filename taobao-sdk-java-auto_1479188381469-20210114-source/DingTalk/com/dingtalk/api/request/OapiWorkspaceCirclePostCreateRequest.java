...
public class OapiWorkspaceCirclePostCreateRequest extends BaseTaobaoRequest<OapiWorkspaceCirclePostCreateResponse> {
	...
	* 创建动态的入参
	...
	public static class FvDingPanFileContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 6367735265862969688L;
		/**
	...
	public static class FvAttachmentsOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 8745372223925178688L;
		/**
		 * 钉盘文件列表
		 */
	...
	public static class FvPhotoOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 8827629146451423864L;
		/**
	...
	public static class FvPhotoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4185516974129464126L;
		/**
		 * 图片内容列表
		 */
		@ApiListField("photos")
	...
	public static class FvVideoContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4896462452516491753L;
		/**
		 * 视频比特率
		 */
		@ApiField("bitrate")
	...
	public static class FvPostContentOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 7899626446863471754L;
		/**
		 * 附件内容
		 */
	...
	public static class FvPostTagOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 8666341639499474115L;
		/**
		 * 标签名
		 */
		@ApiField("name")
	...
	public static class FvPostCreateOpenDto extends TaobaoObject {
		private static final long serialVersionUID = 4346662972123247319L;
		/**
		 * 动态的内容
		 */
		@ApiField("content")
