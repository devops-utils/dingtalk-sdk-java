...
public class OapiSmartworkHrmMasterDeleteRequest extends BaseTaobaoRequest<OapiSmartworkHrmMasterDeleteResponse> {
	...
	* 业务方id(由系统统一分配)
	...
	public static class Fieldlist extends TaobaoObject {
		private static final long serialVersionUID = 1364338413463222525L;
		/**
		 * 字段名
		 */
		@ApiField("name")
	...
	public static class ScopeVo extends TaobaoObject {
		private static final long serialVersionUID = 8323337487597657717L;
		/**
		 * 业务域code
		 */
		@ApiField("scope_code")
	...
	public static class BizDataVo extends TaobaoObject {
		private static final long serialVersionUID = 4726454521161129713L;
		/**
		 * 数据业务时间戳
		 */
		@ApiField("biz_time")
