...
public class OapiSmartworkHrmEmployeeUpdateRequest extends BaseTaobaoRequest<OapiSmartworkHrmEmployeeUpdateResponse> {
	...
	* 添加待入职入参
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 1686796361295318199L;
		/**
		 * 更新的字段code
		 */
		@ApiField("field_code")
	...
	public static class EmpListFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 5211999726989659297L;
		/**
		 * 单个组所有字段
		 */
	...
	public static class GroupMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 1844198692395519116L;
		/**
		 * 需改的字段所在组ID
		 */
		@ApiField("group_id")
	...
	public static class PreEntryEmployeeAddParam extends TaobaoObject {
		private static final long serialVersionUID = 8116681189187171386L;
		/**
		 * 所有组明细
		 */
		@ApiListField("groups")
